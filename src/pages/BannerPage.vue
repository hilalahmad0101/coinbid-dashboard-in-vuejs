<template>
  <div class="flex">
    ...
    <div class="h-full w-full to-[#F5F5F5] from-white bg-gradient-to-r lg:ml-[300px]">
      ...
      <div class="bg-white rounded shadow mx-10 my-5" :class="!isLoading  ? 'p-0':'p-10'">
...
export default {
  ...
  methods: {
    ...
    async getBanners() {
      ...
      const res = await (
        await fetch(`${BASE_URL}admin/banner`, {
          method: "GET",
          headers: {
    ...
    async deleteBanner(id) {
      if (confirm("Are you sure you want to delete")) {
        const res = await (
          await fetch(`${BASE_URL}admin/banner/${id}`, {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
              admin_access_token: localStorage.getItem("token")
