...
<template>
  <div class="flex">
    ...
    <div class="h-full w-full to-[#F5F5F5] from-white bg-gradient-to-r lg:ml-[300px]">
      ...
      <div class="flex justify-between items-center py-4 mx-10">
        <!-- <div class="relative">
            <button
        ...
        <select
          @change="statusChange"
          id="countries"
          class="bg-gray-50 border border-gray-300 text-sm rounded-lg 0 block w-[200px] p-2.5 dark:border-gray-600 dark:placeholder-gray-400 text-black"
        >
          <option selected>Choose a Status</option>
          <option value="1">By Date</option>
          <option value="2">By Paid</option>
          <option value="3">By UnPaid</option>
        </select>
        <div v-if="status == 2">
          <download-csv
            class="bg-[#E27425] cursor-pointer text-white rounded px-3 sm:py-2 py-1 sm:text-[19px] text-sm font-bold font-mulish mb-0"
            :data="store.banks"
          >Download Data</download-csv>
        </div>
      </div>

      <div class="text-center my-5" v-if="store.isloading">
        <div role="status">
          <svg
      ...
      <div class="bg-white rounded-md shadow mx-10 my-5" v-else>
            ...
            <tbody v-for="(bank, index) in store.banks" :key="index" class="border-b">
              <tr>
                ...
                >
                  ...
                  >{{bank.users ==null ? 'User Deleted':bank.users.name}}</span>
                </td>
                <td
